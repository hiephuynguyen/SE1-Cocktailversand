...
| Barbetreiber kann Angebot, Kunden, die negativ sind, verwalten
| Kunden verwalten, Angebot verwalten
| Hoch

| Kunden wollen beliebige Zutaten für Ihre Cooktail wählen
| Zutaten wählen
| Hoch

| Kunden wollen alle Rechnung der Topping usw. berechnen
| Kundenbons berechnen
| Hoch

| Kunden wollen beliebige Zahlungmethode zu wählen
| Zahlungsmethode wahlen
| Mittel

| Barbetreiber, Mitarbeiter können die Bestellung verwalten
